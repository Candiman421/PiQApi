// CertApi.Core/Results/CertSuccessMarker.cs
using CertApi.Abstractions.Results;

namespace CertApi.Core.Results;

/// <summary>
/// Success marker that implements ICertResultError to carry correlation ID for successful results
/// </summary>
internal sealed class CertSuccessMarker : ICertResultError
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertSuccessMarker"/> class
    /// </summary>
    /// <param name="correlationId">The correlation ID to associate with the success result</param>
    public CertSuccessMarker(string correlationId)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertSuccessMarker"/> class with properties
    /// </summary>
    /// <param name="correlationId">The correlation ID</param>
    /// <param name="timestamp">The timestamp when the operation occurred</param>
    /// <param name="properties">Additional properties</param>
    private CertSuccessMarker(string correlationId, DateTimeOffset timestamp, IDictionary<string, object>? properties)
    {
    ...
    public ICertResultError WithProperty(string key, object value)
    {
        ...
        return new CertSuccessMarker(CorrelationId, Timestamp, newProperties);
    }
