// CertApi.Core/Utilities/RandomProviders/CertSystemRandomProvider.cs
...
/// <summary>
/// Implementation of ICertRandomProvider that uses appropriate random generation based on context
/// </summary>
public class CertSystemRandomProvider : ICertRandomProvider
{
    ...
    private readonly ILogger<CertSystemRandomProvider>? _logger;
    ...
    /// </summary>
    public CertSystemRandomProvider() : this(false, null, null) { }
    ...
    public CertSystemRandomProvider(bool useCryptographicRandom)
    ...
    public CertSystemRandomProvider(
        bool useCryptographicRandom,
        ILogger<CertSystemRandomProvider>? logger,
...
#pragma warning restore CA5394
    ...
    public static ICertRandomProvider Create(
        bool useCryptographic,
        ILogger<CertSystemRandomProvider>? logger = null,
        ICertCorrelationContext? correlationContext = null)
    {
        return new CertSystemRandomProvider(useCryptographic, logger, correlationContext);
    }
    ...
    public static ICertRandomProvider CreateSecure(
        ILogger<CertSystemRandomProvider>? logger = null,
        ICertCorrelationContext? correlationContext = null)
    {
        return new CertSystemRandomProvider(true, logger, correlationContext);
    }
    ...
    public static ICertRandomProvider CreateFast(
        ILogger<CertSystemRandomProvider>? logger = null,
        ICertCorrelationContext? correlationContext = null)
    {
        return new CertSystemRandomProvider(false, logger, correlationContext);
    }
