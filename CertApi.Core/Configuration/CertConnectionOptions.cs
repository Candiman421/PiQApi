// CertApi.Core/Configuration/CertConnectionOptions.cs
...
/// </summary>
public record CertConnectionOptions
{
    /// <summary>
    /// Gets or sets the endpoint configuration
    /// </summary>
    [Required]
    public CertEndpointOptions Endpoint { get; init; } = new CertEndpointOptions("Default");
    ...
    /// </summary>
    public CertConnectionOptions WithEndpoint(CertEndpointOptions endpoint) =>
    ...
    /// </summary>
    public CertConnectionOptions WithPoolSize(int poolSize)
    {
        if (poolSize <= 0)
    ...
    /// </summary>
    public CertConnectionOptions WithTimeoutSettings(int idleTimeoutSeconds, int lifetimeSeconds)
    {
    ...
    /// </summary>
    public CertConnectionOptions WithConnectionReuse(bool allowConnectionReuse) =>
        this with { AllowConnectionReuse = allowConnectionReuse };

    /// <summary>
    /// Creates a new options with an additional setting
    /// </summary>
    public CertConnectionOptions WithSetting(string key, string value)
    {
