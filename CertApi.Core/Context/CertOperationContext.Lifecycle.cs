// CertApi.Core/Context/CertOperationContext.Lifecycle.cs
...
public partial class CertOperationContext
{
    ...
    public ICertOperationContext CreateChildContext(string operationName)
    {
        ArgumentException.ThrowIfNullOrEmpty(operationName, nameof(operationName));
        ThrowIfDisposed();

        // Create child identifier
        var childId = new CertOperationIdentifier(
        ...
        var childContext = new CertOperationContext(
            childId,
            new CertOperationState(),
            new CertOperationMetrics(childId.Id, operationName),
            CorrelationContext,
            _validator,
            _resources,
            _logger,
    ...
    public IDisposable CreateScope(string scopeName)
    {
        ...
        return new CertOperationScope(scopeName, this, _logger, Metrics);
    }
