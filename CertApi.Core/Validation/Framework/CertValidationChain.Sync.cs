// CertApi.Core/Validation/Framework/CertValidationChain.Sync.cs
...
public partial class CertValidationChain
{
    ...
    /// </summary>
    private static bool HasErrorsOfSeverity(ICertValidationResult result, ValidationSeverityType severity)
    {
