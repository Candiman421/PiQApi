// CertApi.Core/Validation/Services/CertValidationResultProcessor.cs
...
/// </summary>
public static class CertValidationResultProcessor
{
    /// <summary>
    ...
    public static string? GetCorrelationId(ICertValidationResult result)
    {
    ...
    public static string GetErrorSummary(ICertValidationResult result)
    {
        ArgumentNullException.ThrowIfNull(result);
    ...
    public static IReadOnlyDictionary<string, object> GetValidationContext(ICertValidationResult result)
    {
        ArgumentNullException.ThrowIfNull(result);
