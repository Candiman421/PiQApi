// CertApi.Core/Resilience/CertPolicyFactory.cs
...
/// </summary>
public class CertPolicyFactory : ICertPolicyFactory
{
    private readonly ILogger<CertPolicyFactory> _logger;
    private readonly CertTimeoutOptions _timeoutOptions;
    private readonly CertRetryOptions _retryOptions;
    private readonly CertCircuitBreakerOptions _circuitBreakerOptions;
    private readonly CertBulkheadOptions _bulkheadOptions;
    private readonly ICertRandomProvider _randomProvider;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertPolicyFactory"/> class
    /// </summary>
    public CertPolicyFactory(
        ILogger<CertPolicyFactory> logger,
        CertTimeoutOptions timeoutOptions,
        CertRetryOptions retryOptions,
        CertCircuitBreakerOptions circuitBreakerOptions,
        CertBulkheadOptions bulkheadOptions,
        ICertRandomProvider? randomProvider = null)
    {
        ...
        _randomProvider = randomProvider ?? new CertSystemRandomProvider();
    }
