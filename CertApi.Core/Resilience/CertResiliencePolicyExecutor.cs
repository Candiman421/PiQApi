// CertApi.Core/Resilience/CertResiliencePolicyExecutor.cs
...
/// </summary>
public class CertResiliencePolicyExecutor : ICertResiliencePolicyExecutor
{
    private readonly ICertOperationContext _operationContext;
    private readonly ICertPolicyFactory _policyFactory;
    private readonly ILogger<CertResiliencePolicyExecutor> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the CertResiliencePolicyExecutor class
    /// </summary>
    ...
    public CertResiliencePolicyExecutor(
        ICertOperationContext operationContext,
        ICertPolicyFactory policyFactory,
        ILogger<CertResiliencePolicyExecutor> logger,
