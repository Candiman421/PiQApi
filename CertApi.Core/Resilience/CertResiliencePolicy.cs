// CertApi.Core/Resilience/CertResiliencePolicy.cs
...
/// <summary>
/// Implementation of ICertResiliencePolicy wrapping Polly policies
/// </summary>
public class CertResiliencePolicy : ICertResiliencePolicy
{
    private readonly IAsyncPolicy _policy;
    private readonly ILogger<CertResiliencePolicy> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertResiliencePolicy"/> class
    /// </summary>
    ...
    public CertResiliencePolicy(
        IAsyncPolicy policy,
        ILogger<CertResiliencePolicy> logger,
