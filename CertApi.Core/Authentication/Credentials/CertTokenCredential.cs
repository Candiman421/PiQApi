// CertApi.Core/Authentication/Credentials/CertTokenCredential.cs
using CertApi.Abstractions.Authentication.Models;

namespace CertApi.Core.Authentication.Credentials;
