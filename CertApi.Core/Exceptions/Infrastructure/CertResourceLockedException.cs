// CertApi.Core/Exceptions/Infrastructure/CertResourceLockedException.cs
...
/// </summary>
public sealed class CertResourceLockedException : CertServiceException
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertResourceLockedException"/> class
    /// </summary>
    public CertResourceLockedException()
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertResourceLockedException"/> class with a specified error message
    /// </summary>
    /// <param name="message">The message that describes the error</param>
    public CertResourceLockedException(string message)
    ...
    public CertResourceLockedException(string message, Exception? inner)
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertResourceLockedException"/> class with a specified resource identifier
    /// and lock owner
    /// </summary>
    ...
    public CertResourceLockedException(string resourceId, string? lockOwner)
    ...
    /// <param name="lockOwner">The identifier of the lock owner</param>
    /// <param name="inner">The exception that is the cause of the current exception</param>
    public CertResourceLockedException(string resourceId, string? lockOwner, Exception? inner)
