// CertApi.Core/Exceptions/Infrastructure/CertResourceQuotaExceededException.cs
...
/// </summary>
public sealed class CertResourceQuotaExceededException : CertServiceException
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertResourceQuotaExceededException"/> class
    /// </summary>
    public CertResourceQuotaExceededException()
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertResourceQuotaExceededException"/> class with a specified error message
    /// </summary>
    /// <param name="message">The message that describes the error</param>
    public CertResourceQuotaExceededException(string message)
    ...
    public CertResourceQuotaExceededException(string message, Exception? inner)
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertResourceQuotaExceededException"/> class with a specified resource type,
    ...
    public CertResourceQuotaExceededException(string resourceType, long currentSize, long maxSize)
    ...
    /// <param name="maxSize">The maximum allowed size of the resource</param>
    /// <param name="inner">The exception that is the cause of the current exception</param>
    public CertResourceQuotaExceededException(string resourceType, long currentSize, long maxSize, Exception? inner)
