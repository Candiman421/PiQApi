// CertApi.Core/Exceptions/Infrastructure/CertConnectionException.cs
...
/// </summary>
public class CertConnectionException : CertServiceException
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertConnectionException"/> class
    /// </summary>
    public CertConnectionException()
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertConnectionException"/> class with a specified error message
    /// </summary>
    /// <param name="message">The message that describes the error</param>
    public CertConnectionException(string message)
        : base(message)
    {
        ServiceUri = null;
        RequestId = null;
    ...
    public CertConnectionException(string message, Exception? inner)
        : base(message, inner)
    {
        ServiceUri = null;
        RequestId = null;
    ...
    /// <param name="inner">The exception that is the cause of the current exception</param>
    public CertConnectionException(string message, Uri? serviceUri, string? requestId, Exception? inner = null)
