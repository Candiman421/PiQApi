// CertApi.Core/Core/CertResourceContext.cs
...
/// </summary>
public sealed class CertResourceContext : ICertResourceContext, IDisposable
{
    private readonly ILogger<CertResourceContext> _logger;
    private readonly ICertResourceManager _resourceManager;
    ...
    /// </summary>
    public ICertResourceMetrics Metrics { get; }

    /// <summary>
    /// Initializes a new instance of the <see cref="CertResourceContext"/> class
    /// </summary>
    ...
    public CertResourceContext(
        ICertCorrelationContext correlationContext,
        ICertResourceMetrics metrics,
        ICertResourceManager resourceManager,
        ICertExceptionFactory exceptionFactory,
        ILogger<CertResourceContext> logger)
    {
    ...
    /// <exception cref="CertResourceNotFoundException">Thrown when the resource is not found</exception>
    public T GetResource<T>(string resourceId) where T : class, ICertResource
    {
    ...
    public IReadOnlyCollection<T> GetTrackedResources<T>() where T : class, ICertResource
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
    ...
    /// <exception cref="CertResourceLockedException">Thrown when a resource cannot be acquired</exception>
    public async Task<ICertResourceScope> CreateResourceScopeAsync(IEnumerable<string> resourceIds, CancellationToken cancellationToken = default)
    {
        ...
        return new CertAsyncResourceScope(this, scopeResources, _logger);
    }
