// CertApi.Core/Core/CertResourceScope.cs
...
/// </summary>
public class CertResourceScope : ICertResourceScope
{
    ...
    {
        ObjectDisposedException.ThrowIf(_isDisposed, nameof(CertResourceScope));
    }
}