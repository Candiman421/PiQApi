// CertApi.Core/Service/CertServiceResponseCollection.cs
...
public sealed class CertServiceResponseCollection<T> : Collection<T> where T : ICertServiceResponse
{
    /// <summary>
    /// Initializes a new instance of the CertServiceResponseCollection class
    /// </summary>
    public CertServiceResponseCollection()
        : base(new List<T>())
    {
    }
    ...
    public CertServiceResponseCollection(IList<T> items)
    ...
    /// </summary>
    public bool HasErrorOfType<TError>() where TError : CertServiceException =>
        this.Any(r => r.Exception is TError);

    /// <summary>
    /// Gets all errors of the specified type
    /// </summary>
    public IEnumerable<TError> GetErrorsOfType<TError>() where TError : CertServiceException =>
