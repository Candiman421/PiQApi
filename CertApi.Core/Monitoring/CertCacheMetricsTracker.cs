// CertApi.Core/Monitoring/CertCacheMetricsTracker.cs
...
/// </summary>
public class CertCacheMetricsTracker : ICertCacheMetrics
{
    private readonly ILogger<CertCacheMetricsTracker> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the CertCacheMetricsTracker class
    /// </summary>
    ...
    public CertCacheMetricsTracker(
        ILogger<CertCacheMetricsTracker> logger,
