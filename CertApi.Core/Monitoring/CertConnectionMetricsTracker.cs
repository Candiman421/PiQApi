// CertApi.Core/Monitoring/CertConnectionMetricsTracker.cs
...
/// </summary>
public class CertConnectionMetricsTracker : ICertConnectionMetrics
{
    private readonly ILogger<CertConnectionMetricsTracker> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the CertConnectionMetricsTracker class
    /// </summary>
    ...
    public CertConnectionMetricsTracker(
        ILogger<CertConnectionMetricsTracker> logger,
    ...
    public async Task<ICertMetricsSnapshot> GetMetricsSnapshotAsync(CancellationToken cancellationToken = default)
    {
        ...
        var snapshot = new CertMetricsSnapshot(
