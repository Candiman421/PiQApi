// CertApi.Core/Monitoring/CertOperationMetricsTracker.cs
...
/// </summary>
public class CertOperationMetricsTracker : ICertOperationMetrics
{
    private readonly ILogger<CertOperationMetricsTracker> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CertOperationMetricsTracker"/> class
    /// </summary>
    /// <param name="logger">Logger instance</param>
    /// <param name="timeProvider">Time provider for improved testability</param>
    public CertOperationMetricsTracker(
        ILogger<CertOperationMetricsTracker> logger,
