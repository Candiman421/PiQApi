// CertApi.Core/Monitoring/CertOperationMetricsOptions.cs
...
/// </summary>
public record CertOperationMetricsOptions
{
    /// <summary>
    ...
    public CertOperationMetricsOptions WithSamplingRate(double samplingRate)
    {
    ...
    /// <returns>New options instance</returns>
    public CertOperationMetricsOptions WithEnabled(bool isEnabled)
    {
    ...
    /// <returns>New options instance</returns>
    public CertOperationMetricsOptions WithLogSlowOperations(bool logSlowOperations)
    {
    ...
    /// <returns>New options instance</returns>
    public CertOperationMetricsOptions WithLongRunningThreshold(long thresholdMs)
    {
        if (thresholdMs < 0)
