// CertApi.Abstractions/Core/ICertResourceManager.cs
namespace CertApi.Abstractions.Core;

/// <summary>
/// Manages tracked resources and resource scopes
/// </summary>
public interface ICertResourceManager : IAsyncDisposable
{
    /// <summary>
    ...
    Task<ICertResourceScope> CreateScopeAsync(string? scopeId = null, CancellationToken cancellationToken = default);
