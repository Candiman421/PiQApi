// CertApi.Abstractions/Core/ICertResourceContext.cs
namespace CertApi.Abstractions.Core;

/// <summary>
/// Provides context for resource operations and management
/// </summary>
public interface ICertResourceContext : ICertCorrelationAware
{
    /// <summary>
    ...
    T GetResource<T>(string resourceId) where T : class, ICertResource;
    ...
    /// </summary>
    ICertResourceMetrics Metrics { get; }
    ...
    IReadOnlyCollection<T> GetTrackedResources<T>() where T : class, ICertResource;
