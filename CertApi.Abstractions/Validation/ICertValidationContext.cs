// CertApi.Abstractions/Validation/ICertValidationContext.cs
...
namespace CertApi.Abstractions.Validation
{
    ...
    /// </summary>
    public interface ICertValidationContext
    {
        /// <summary>
        ...
        ICertValidationContext CreateChildContext();
        ...
        ICertValidationContext WithContextValue(string key, object value);
        ...
        ICertValidationContext WithMode(ValidationModeType mode);
        ...
        ICertValidationContext WithCancellationToken(CancellationToken cancellationToken);
    }
}