// CertApi.Abstractions/Validation/CertValidationContext.cs
...
namespace CertApi.Abstractions.Validation
{
    ...
    /// </summary>
    public class CertValidationContext
    {
        /// <summary>
        ...
        /// </summary>
        public CertValidationContext(string correlationId, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public CertValidationContext(CancellationToken cancellationToken = default)
