// CertApi.Abstractions/Validation/CertValidationResult.cs
...
{
    public sealed class CertValidationResult
    {
        ...
        private CertValidationResult()
        {
            Debug.WriteLine($"CertValidationResult created: {GetHashCode()}");
        }
        ...
        public static CertValidationResult Error(string message, ValidationSeverityType severity = ValidationSeverityType.Error)
        {
        ...
        public static CertValidationResult FromErrors(IEnumerable<ValidationError> errors)
        {
        ...
        public void Merge(CertValidationResult other)
        {
