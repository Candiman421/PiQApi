// CertApi.Abstractions/Factories/ICertExceptionFactory.cs
...
/// </summary>
public interface ICertExceptionFactory
{
    /// <summary>
    ...
    /// </summary>
    Exception CreatePropertyValidationException(string propertyName, string message, Exception? inner = null);

    /// <summary>
    /// Creates an object disposed exception
    /// </summary>
    Exception CreateObjectDisposedException(string objectName, string message, Exception? inner = null);
}
