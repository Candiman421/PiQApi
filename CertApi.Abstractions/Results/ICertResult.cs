// CertApi.Abstractions/Results/ICertResult.cs
...
public interface ICertResult
{
    ...
    /// </summary>
    ICertResultError? ErrorInfo { get; }
    ...
    ICertResult WithProperty(string key, object value);
    ...
    ICertResult WithProperties(IDictionary<string, object> properties);
}
