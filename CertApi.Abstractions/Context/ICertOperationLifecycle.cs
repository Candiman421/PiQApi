// CertApi.Abstractions/Context/ICertOperationLifecycle.cs
namespace CertApi.Abstractions.Context;

/// <summary>
/// Defines lifecycle operations for an operation context
/// </summary>
public interface ICertOperationLifecycle
{
    /// <summary>
    ...
    ICertOperationContext CreateChildContext(string operationName);
