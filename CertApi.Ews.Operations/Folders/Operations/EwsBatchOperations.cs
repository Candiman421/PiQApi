// CertApi.Ews.Operations/Folders/Operations/EwsBatchOperations.cs
...
using CertApi.Ews.Operations.Core.Base;
using CertApi.Ews.Operations.Folders.Interfaces;
...
namespace CertApi.Ews.Operations.Folders.Operations
{
    /// <summary>
