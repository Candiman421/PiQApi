// PiQApi.Core/Configuration/PiQConnectionOptionsValidator.cs
...
/// </summary>
public class PiQConnectionOptionsValidator : IValidateOptions<PiQConnectionOptions>
{
    private readonly ILogger<PiQConnectionOptionsValidator> _logger;
    ...
    /// <summary>
    /// Creates a new instance of PiQConnectionOptionsValidator
    /// </summary>
    public PiQConnectionOptionsValidator(ILogger<PiQConnectionOptionsValidator> logger)
    {
    ...
    /// </summary>
    public ValidateOptionsResult Validate(string? name, PiQConnectionOptions options)
    {
