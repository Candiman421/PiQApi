// PiQApi.Core/Threading/PiQAsyncSemaphore.cs
...
/// </summary>
public sealed class PiQAsyncSemaphore : IAsyncDisposable
{
    private readonly SemaphoreSlim _semaphore;
    private readonly ILogger<PiQAsyncSemaphore>? _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the PiQAsyncSemaphore class
    /// </summary>
    ...
    public PiQAsyncSemaphore(int initialCount, int maxCount)
        : this(Guid.NewGuid().ToString(), initialCount, maxCount, null)
    {
    }

    /// <summary>
    /// Initializes a new instance of the PiQAsyncSemaphore class with an ID
    /// </summary>
    /// <param name="id">The identifier for this semaphore</param>
    /// <param name="initialCount">The initial number of requests that can be granted concurrently</param>
    /// <param name="maxCount">The maximum number of requests that can be granted concurrently</param>
    /// <param name="logger">Optional logger instance</param>
    public PiQAsyncSemaphore(string id, int initialCount, int maxCount, ILogger<PiQAsyncSemaphore>? logger = null)
    {
    ...
    {
        private readonly PiQAsyncSemaphore _semaphore;
        private bool _disposed;

        public SemaphoreReleaser(PiQAsyncSemaphore semaphore)
        {
