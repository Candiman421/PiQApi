// PiQApi.Core/Threading/PiQAsyncLock.cs
...
/// </summary>
public sealed partial class PiQAsyncLock : IPiQAsyncLock, IAsyncDisposable
{
    ...
    // Logger delegates shared with PiQAsyncLock.Operations.cs moved there to avoid duplication
    #endregion
    ...
    /// <summary>
    /// Initializes a new instance of the PiQAsyncLock class
    /// </summary>
    public PiQAsyncLock() : this(Guid.NewGuid().ToString(), null)
    {
    }
