// PiQApi.Core/Core/PiQCorrelationScopeDisposer.cs
...
/// </summary>
internal sealed class PiQCorrelationScopeDisposer : IDisposable
{
    private readonly PiQCorrelationContext _context;
    private readonly PiQCorrelationScopeState _scopeState;
    ...
    public PiQCorrelationScopeDisposer(
        PiQCorrelationContext context,
        PiQCorrelationScopeState scopeState,
        ILogger logger)
    {
