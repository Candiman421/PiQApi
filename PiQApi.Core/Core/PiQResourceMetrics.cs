// PiQApi.Core/Core/PiQResourceMetrics.cs
...
/// <summary>
/// Thread-safe implementation of IPiQResourceMetrics
/// </summary>
public class PiQResourceMetrics : IPiQResourceMetrics
{
    ...
    public async Task<IPiQMetricsSnapshot> GetMetricsSnapshotAsync(CancellationToken cancellationToken = default)
    {
        ...
        var snapshot = new PiQMetricsSnapshot(CreateSnapshot());
