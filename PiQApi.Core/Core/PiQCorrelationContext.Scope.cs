// PiQApi.Core/Core/PiQCorrelationContext.Scope.cs
...
public sealed partial class PiQCorrelationContext
{
    ...
    public IDisposable CreateScope()
    {
        ...
        var scopeState = new PiQCorrelationScopeState(parentId);
        ...
        return new PiQCorrelationScopeDisposer(this, scopeState, _logger);
    }
    ...
    /// </summary>
    /// <remarks>
    /// This method is used by PiQCorrelationScope to manage scope without static methods
    /// </remarks>
