// PiQApi.Core/Monitoring/PiQCompositeMetricsTracker.cs
...
/// <summary>
/// Implementation of IPiQCompositeMetricsTracker that combines multiple metrics trackers
/// </summary>
public class PiQCompositeMetricsTracker : IPiQCompositeMetricsTracker
{
    private readonly ILogger<PiQCompositeMetricsTracker> _logger;
    private readonly ConcurrentBag<IPiQOperationMetrics> _trackers = new();
    ...
    private static readonly Action<ILogger, string, IPiQOperationMetrics, Exception?> LogTrackerAdded =
        LoggerMessage.Define<string, IPiQOperationMetrics>(
            LogLevel.Debug,
    ...
    public PiQCompositeMetricsTracker(
        ILogger<PiQCompositeMetricsTracker> logger,
    ...
    #region IPiQConnectionMetrics Implementation
    ...
    #region IPiQCacheMetrics Implementation
    ...
    #region IPiQMetricsProvider Implementation
    ...
    public void ResetCounters()
    {
        ...
        foreach (var tracker in _trackers)
        {
            if (tracker is IPiQMetricsProvider metricsProvider)
            {
    ...
    #region IPiQCompositeMetricsTracker Implementation
    ...
    public void AddTracker(IPiQOperationMetrics tracker)
    {
