// PiQApi.Core/Monitoring/PiQMetricsSnapshot.cs
...
/// </summary>
public sealed class PiQMetricsSnapshot : IPiQMetricsSnapshot, IEquatable<PiQMetricsSnapshot>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQMetricsSnapshot"/> class
    /// </summary>
    public PiQMetricsSnapshot()
        : this(ImmutableDictionary<string, object>.Empty, DateTimeOffset.UtcNow)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="PiQMetricsSnapshot"/> class with metrics
    /// </summary>
    /// <param name="metrics">Initial metrics dictionary</param>
    public PiQMetricsSnapshot(IDictionary<string, object> metrics)
        : this(metrics?.ToImmutableDictionary() ?? ImmutableDictionary<string, object>.Empty, DateTimeOffset.UtcNow)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="PiQMetricsSnapshot"/> class with the specified timestamp
    /// </summary>
    /// <param name="metrics">Metrics dictionary</param>
    /// <param name="timestamp">Timestamp</param>
    public PiQMetricsSnapshot(ImmutableDictionary<string, object> metrics, DateTimeOffset timestamp)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQMetricsSnapshot"/> class with common metrics
    /// </summary>
    ...
    public IPiQMetricsSnapshot WithMetric(string name, object value)
    {
        ...
        return new PiQMetricsSnapshot(_metrics.SetItem(name, value), Timestamp)
        {
    ...
    public IPiQMetricsSnapshot WithMetrics(IDictionary<string, object> metrics)
    {
        ...
        return new PiQMetricsSnapshot(builder.ToImmutable(), Timestamp)
        {
            SuccessfulOperations = SuccessfulOperations,
            FailedOperations = FailedOperations,
            TotalDurationMs = TotalDurationMs,
    ...
    /// </summary>
    public bool Equals(PiQMetricsSnapshot? other)
    {
        if (other is null)
            return false;
    ...
    {
        return ReferenceEquals(this, obj) || obj is PiQMetricsSnapshot other && Equals(other);
    }
    ...
    /// Equality operator
    /// </summary>
    public static bool operator ==(PiQMetricsSnapshot? left, PiQMetricsSnapshot? right)
    {
