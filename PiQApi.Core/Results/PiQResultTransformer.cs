// PiQApi.Core/Results/PiQResultTransformer.cs
...
/// </summary>
public class PiQResultTransformer : IPiQResultTransformer
{
    private readonly IPiQCorrelationContext _correlationContext;
    private readonly IPiQResultFactory _resultFactory;

    /// <summary>
    /// Initializes a new instance of the <see cref="PiQResultTransformer"/> class
    /// </summary>
    ...
    public IPiQResult<T> FromValidation<T>(IPiQValidationResult validation, T? value = default)
    {
    ...
    /// <exception cref="ArgumentNullException">Thrown when validation is null</exception>
    public IPiQServiceResult<T> FromValidationToService<T>(
        IPiQValidationResult validation,
        T? value = default,
        string requestId = "")
    {
        ArgumentNullException.ThrowIfNull(validation);
    ...
    public IPiQResult<TNew> Map<T, TNew>(IPiQResult<T> result, Func<T, TNew> mapper)
    {
    ...
    /// <exception cref="ArgumentNullException">Thrown when result or mapper is null</exception>
    public IPiQServiceResult<TNew> MapService<T, TNew>(
        IPiQServiceResult<T> result,
        Func<T, TNew> mapper)
    {
        ArgumentNullException.ThrowIfNull(result);
        ArgumentNullException.ThrowIfNull(mapper);
