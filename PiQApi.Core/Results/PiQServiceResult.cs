// PiQApi.Core/Results/PiQServiceResult.cs
...
/// <summary>
/// Base implementation of IPiQServiceResult
/// </summary>
public class PiQServiceResult : PiQResult, IPiQServiceResult
{
    /// <summary>
    ...
    protected internal static PiQServiceResult CreateSuccess(
        ...
        string? correlationId = null)
    {
        ...
        return new PiQServiceResult(true, successMarker, status, requestId, correlationId ?? string.Empty, DateTimeOffset.UtcNow);
    }
    ...
    protected internal static PiQServiceResult CreateFailure(
        string code,
        string message,
        OperationStatusType status,
        string requestId,
        string? correlationId = null)
    {
        ...
        return new PiQServiceResult(false, error, status, requestId, correlationId ?? error.CorrelationId, DateTimeOffset.UtcNow);
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="PiQServiceResult"/> class
    /// </summary>
    ...
    public new IPiQServiceResult WithProperty(string key, object value)
    {
        ...
        return new PiQServiceResult(IsSuccess, ErrorInfo, Status, RequestId, CorrelationId, Timestamp, newProperties);
    }
    ...
    public new IPiQServiceResult WithProperties(IDictionary<string, object> properties)
    {
    ...
    public IPiQServiceResult WithStatus(OperationStatusType status)
    {
        return new PiQServiceResult(IsSuccess, ErrorInfo, status, RequestId, CorrelationId, Timestamp, new Dictionary<string, object>(Properties));
    }
}
