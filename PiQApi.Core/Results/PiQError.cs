// PiQApi.Core/Results/PiQError.cs
using PiQApi.Abstractions.Results;

namespace PiQApi.Core.Results;

/// <summary>
/// Implementation of IPiQResultError
/// </summary>
public class PiQError : IPiQResultError
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQError"/> class
    /// </summary>
    /// <param name="code">ErrorInfo code</param>
    /// <param name="message">ErrorInfo message</param>
    /// <param name="correlationId">Optional correlation ID</param>
    public PiQError(string code, string message, string? correlationId = null)
    {
        Code = code ?? "PiQError";
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQError"/> class with properties
    /// </summary>
    ...
    protected PiQError(string code, string message, string correlationId, DateTimeOffset timestamp, IDictionary<string, object>? properties)
    {
        Code = code;
        Message = message;
    ...
    public IPiQResultError WithProperty(string key, object value)
    {
        ...
        return new PiQError(Code, Message, CorrelationId, Timestamp, newProperties);
    }
