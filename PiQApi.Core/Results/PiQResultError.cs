// PiQApi.Core/Results/PiQResultError.cs
...
/// </summary>
public class PiQResultError : IPiQResultError
{
    ...
    /// </summary>
    public PiQResultError(string code, string message)
    {
        Code = code;
        Message = message;
    }
    ...
    /// </summary>
    public PiQResultError(string code, string message, string correlationId)
    {
        Code = code;
        Message = message;
    ...
    /// </summary>
    public PiQResultError(string code, string message, string correlationId, IDictionary<string, object>? properties = null)
    {
        Code = code;
        Message = message;
        CorrelationId = correlationId;
    ...
    public IPiQResultError WithProperty(string key, object value)
    {
        ...
        return new PiQResultError(Code, Message, CorrelationId, properties);
    }
    ...
    public IPiQResultError WithProperties(IDictionary<string, object> properties)
    {
        ...
        return new PiQResultError(Code, Message, CorrelationId, mergedProperties);
    }
}