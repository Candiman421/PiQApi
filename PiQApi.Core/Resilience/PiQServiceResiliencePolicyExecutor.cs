// PiQApi.Core/Resilience/PiQServiceResiliencePolicyExecutor.cs
...
/// </summary>
public class PiQServiceResiliencePolicyExecutor : PiQResiliencePolicyExecutor, IPiQServiceResiliencePolicyExecutor
{
    private readonly IPiQOperationContext _operationContext;
    private readonly IPiQTimeProvider _timeProvider;
    private readonly ILogger<PiQServiceResiliencePolicyExecutor> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQServiceResiliencePolicyExecutor"/> class
    /// </summary>
    ...
    public async Task<IPiQServiceResult<T>> ExecuteWithServiceMappingAsync<T>(
