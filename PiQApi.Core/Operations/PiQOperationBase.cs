// PiQApi.Core/Operations/PiQOperationBase.cs
...
/// </summary>
public abstract partial class PiQOperationBase : IPiQOperationBase, IAsyncDisposable
{
    private readonly IPiQAsyncLock _asyncLock;
    ...
    /// </summary>
    public IPiQOperationContext Context { get; }

    /// <summary>
    /// Initializes a new instance of the <see cref="PiQOperationBase"/> class
    /// </summary>
