// PiQApi.Core/Operations/PiQOperationBase.Lifecycle.cs
using PiQApi.Abstractions.Enums;

namespace PiQApi.Core.Operations;

public abstract partial class PiQOperationBase : IAsyncDisposable
{
    /// <summary>
    ...
    {
        ObjectDisposedException.ThrowIf(_isDisposed, nameof(PiQOperationBase));
