// PiQApi.Core/Operations/PiQOperationBase.Logging.cs
using PiQApi.Core.Utilities.Disposables;
using Microsoft.Extensions.Logging;

namespace PiQApi.Core.Operations;

public abstract partial class PiQOperationBase
{
    ...
    protected IDisposable CreateLoggingScope(IDictionary<string, object>? additionalData = null)
    {
        ...
        return _logger.BeginScope(scopeData) ?? new PiQDisposableAction(() => { });
    }
    ...
    protected IDisposable CreateScope(string operationName)
    {
        ...
        return Context.CreateScope(operationName) ?? new PiQDisposableAction(() => { });
    }
