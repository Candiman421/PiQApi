// PiQApi.Core/Authentication/PiQAuthenticationOptionsValidator.cs
...
/// </summary>
public class PiQAuthenticationOptionsValidator : IValidateOptions<PiQAuthenticationOptions>
{
    /// <summary>
    /// Validates authentication options
    /// </summary>
    public ValidateOptionsResult Validate(string? name, PiQAuthenticationOptions options)
    {
