// PiQApi.Core/Authentication/TokenCache/PiQMemoryTokenCache.cs
...
/// </summary>
public class PiQMemoryTokenCache : IPiQTokenCache
{
    ...
    private readonly ILogger<PiQMemoryTokenCache> _logger;
    private readonly IPiQCacheMetrics _cacheMetrics;
    private readonly ConcurrentDictionary<string, PiQTokenInfo> _cache;
    private readonly PiQCacheOptions _options;
    private readonly IPiQCorrelationContext _correlationContext;
    private readonly IPiQAsyncLock _cacheLock;
    private bool _isDisposed;

    /// <summary>
    /// Initializes a new instance of the <see cref="PiQMemoryTokenCache"/> class
    /// </summary>
    ...
    public PiQMemoryTokenCache(
        ILogger<PiQMemoryTokenCache> logger,
        IOptions<PiQCacheOptions> options,
        IPiQCacheMetrics cacheMetrics,
        IPiQCorrelationContext correlationContext,
        IPiQAsyncLockFactory asyncLockFactory)
    {
        ...
        _cache = new ConcurrentDictionary<string, PiQTokenInfo>(StringComparer.OrdinalIgnoreCase);
    ...
    /// </summary>
    public async Task<PiQTokenInfo?> GetTokenAsync(string cacheKey, CancellationToken cancellationToken = default)
    {
    ...
    /// </summary>
    public async Task SetTokenAsync(string cacheKey, PiQTokenInfo token, CancellationToken cancellationToken = default)
    {
        ObjectDisposedException.ThrowIf(_isDisposed, this);
        ArgumentException.ThrowIfNullOrEmpty(cacheKey);
