// PiQApi.Core/Authentication/PiQAuthenticationOptions.cs
...
/// </summary>
public record PiQAuthenticationOptions : IPiQAuthenticationOptions
{
    /// <summary>
    ...
    /// </summary>
    public PiQRetryOptions RetryOptions { get; init; } = new PiQRetryOptions();
