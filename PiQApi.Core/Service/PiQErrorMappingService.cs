// PiQApi.Core/Service/PiQErrorMappingService.cs
...
/// </summary>
public class PiQErrorMappingService : IPiQErrorMappingService
{
    private readonly ILogger<PiQErrorMappingService> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQErrorMappingService"/> class
    /// </summary>
    /// <param name="logger">The logger</param>
    /// <param name="exceptionFactory">The exception factory</param>
    /// <param name="correlationContext">The correlation context</param>
    /// <exception cref="ArgumentNullException">Thrown when any parameter is null</exception>
    public PiQErrorMappingService(
        ILogger<PiQErrorMappingService> logger,
