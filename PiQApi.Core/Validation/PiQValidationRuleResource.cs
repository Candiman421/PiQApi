// PiQApi.Core/Validation/PiQValidationRuleResource.cs
...
/// </summary>
public class PiQValidationRuleResource : IPiQResource
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the PiQValidationRuleResource class
    /// </summary>
    public PiQValidationRuleResource(
        string resourceId,
        string resourceType,
        string name,
    ...
    /// </summary>
    public static PiQValidationRuleResource Success(
        string resourceId,
        string resourceType,
        string name,
        Dictionary<string, object>? properties = null)
    ...
    /// </summary>
    public static PiQValidationRuleResource Failure(
        string resourceId,
        string resourceType,
        string name,
