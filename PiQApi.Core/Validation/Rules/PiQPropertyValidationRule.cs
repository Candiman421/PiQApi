// PiQApi.Core/Validation/Rules/PiQPropertyValidationRule.cs
...
namespace PiQApi.Core.Validation.Rules
{
    ...
    public class PiQPropertyValidationRule<T> : PiQBaseValidationRule<T> where T : class
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PiQPropertyValidationRule{T}"/> class
        /// </summary>
        ...
        public PiQPropertyValidationRule(
            ILogger logger,
