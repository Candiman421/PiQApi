// PiQApi.Core/Validation/Rules/PiQFileExtensionValidationRule.cs
...
namespace PiQApi.Core.Validation.Rules
{
    ...
    public class PiQFileExtensionValidationRule<T> : PiQBaseValidationRule<T> where T : class
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PiQFileExtensionValidationRule{T}"/> class
        /// </summary>
        ...
        public PiQFileExtensionValidationRule(
            ILogger logger,
