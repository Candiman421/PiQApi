// PiQApi.Core/Validation/Rules/PiQHeaderValidationRule.cs
...
namespace PiQApi.Core.Validation.Rules
{
    ...
    public class PiQHeaderValidationRule<T> : PiQBaseValidationRule<T> where T : class
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PiQHeaderValidationRule{T}"/> class
        /// </summary>
        ...
        public PiQHeaderValidationRule(
            ILogger logger,
