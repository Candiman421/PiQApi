// PiQApi.Core/Validation/Services/PiQValidationService.cs
...
namespace PiQApi.Core.Validation.Services
{
    ...
    /// </summary>
    public class PiQValidationService : IPiQValidationService
    {
        private readonly IPiQValidationProcessor _validationProcessor;
        private readonly ILogger<PiQValidationService> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PiQValidationService"/> class
        /// </summary>
        /// <param name="validationProcessor">Validation processor</param>
        /// <param name="logger">Logger</param>
        /// <param name="timeProvider">Time provider</param>
        public PiQValidationService(
            IPiQValidationProcessor validationProcessor,
            ILogger<PiQValidationService> logger,
        ...
        /// <returns>Validation result</returns>
        public async Task<IPiQValidationResult> ValidateAsync<T>(
            T entity,
        ...
        public IPiQValidationContext CreateContext(
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>A validation context</returns>
        private IPiQValidationContext CreateContextFromOptions(object options, CancellationToken cancellationToken)
        {
