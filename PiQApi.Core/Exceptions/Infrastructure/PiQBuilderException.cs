// PiQApi.Core/Exceptions/Infrastructure/PiQBuilderException.cs
...
/// </summary>
public sealed class PiQBuilderException : PiQServiceException
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQBuilderException"/> class
    /// </summary>
    public PiQBuilderException()
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQBuilderException"/> class with a specified error message
    /// </summary>
    /// <param name="message">The message that describes the error</param>
    public PiQBuilderException(string message)
    ...
    public PiQBuilderException(string message, Exception? inner)
    ...
    public PiQBuilderException(string message, string propertyName)
        : base(message, "BuilderError")
    {
    ...
    public PiQBuilderException(string message, string propertyName, string? errorCode)
    ...
    public PiQBuilderException(string message, string propertyName, object? attemptedValue)
        : base(message, "BuilderError")
    {
        PropertyName = propertyName ?? string.Empty;
    ...
    /// <param name="attemptedValue">The value that was attempted to be set</param>
    /// <param name="inner">The exception that is the cause of the current exception</param>
    public PiQBuilderException(string message, string propertyName, string? errorCode, object? attemptedValue, Exception? inner)
    ...
    /// <returns>A <see cref="PiQBuilderException"/> for invalid builder state</returns>
    public static PiQBuilderException ForInvalidState(string currentState, string requiredState, Exception? inner = null)
    {
        var message = $"Builder is in state '{currentState}' but requires state '{requiredState}' for this operation";
        var exception = new PiQBuilderException(message, "BuilderStateError", inner);
