// PiQApi.Core/Context/PiQOperationResources.cs
...
/// </summary>
public class PiQOperationResources : IPiQOperationResources
{
    private readonly IPiQResourceContext _resourceContext;
    private readonly ILogger<PiQOperationResources> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the PiQOperationResources class
    /// </summary>
    /// <param name="resourceContext">Resource context</param>
    /// <param name="logger">Logger</param>
    public PiQOperationResources(IPiQResourceContext resourceContext, ILogger<PiQOperationResources> logger)
    {
        ...
        where T : class, IPiQResource
    {
        ...
        try
        {
            // Note: GetResource is non-async in IPiQResourceContext
