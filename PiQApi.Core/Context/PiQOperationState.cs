// PiQApi.Core/Context/PiQOperationState.cs
...
/// </summary>
public sealed class PiQOperationState : IPiQOperationState
{
    /// <summary>
    /// Creates a new instance of the operation state
    /// </summary>
    /// <param name="status">Initial status</param>
    public PiQOperationState(OperationStatusType status = OperationStatusType.Created)
    {
