// PiQApi.Core/Context/PiQOperationContext.Resources.cs
...
public partial class PiQOperationContext
{
    ...
    public Task<T> GetResourceAsync<T>(string resourceId, CancellationToken cancellationToken = default) where T : class, IPiQResource
    {
        ThrowIfDisposed();
    ...
    public Task<T> TrackResourceAsync<T>(T resource, CancellationToken cancellationToken = default) where T : class, IPiQResource
    {
        ThrowIfDisposed();
    ...
    public Task<IPiQResourceScope> CreateResourceScopeAsync(IEnumerable<string> resourceIds, CancellationToken cancellationToken = default)
    {
        ThrowIfDisposed();
