// PiQApi.Core/Context/PiQCorrelationScope.cs
...
/// </summary>
public class PiQCorrelationScope : IPiQCorrelationScope, IDisposable
{
    ...
    /// </summary>
    public IPiQCorrelationContext Context { get; }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PiQCorrelationScope"/> class
    /// </summary>
    /// <param name="context">Parent correlation context</param>
    /// <param name="logger">Logger</param>
    public PiQCorrelationScope(IPiQCorrelationContext context, ILogger logger)
    {
