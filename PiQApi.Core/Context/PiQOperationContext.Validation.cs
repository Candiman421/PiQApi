// PiQApi.Core/Context/PiQOperationContext.Validation.cs
...
public partial class PiQOperationContext
{
    ...
    /// </summary>
    public Task<IPiQValidationResult> ValidateAsync<T>(T entity, ValidationModeType mode, CancellationToken cancellationToken = default) where T : class
    {
    ...
    /// </summary>
    public Task<IPiQValidationResult> ValidateRequiredAsync<T>(T entity, CancellationToken cancellationToken = default) where T : class
    {
        ArgumentNullException.ThrowIfNull(entity);
    ...
    /// </summary>
    public Task<IPiQResult<T>> ValidateAndCreateResultAsync<T>(T entity, ValidationModeType mode, CancellationToken cancellationToken = default) where T : class
    {
        ArgumentNullException.ThrowIfNull(entity);
