// PiQApi.Core/Context/PiQOperationContext.cs
...
/// </summary>
public partial class PiQOperationContext : IPiQOperationContext, IAsyncDisposable
{
    ...
    private readonly IPiQOperationValidator _validator;
    private readonly IPiQOperationResources _resources;

    /// <summary>
    /// Initializes a new instance of the <see cref="PiQOperationContext"/> class
    /// </summary>
    ...
    public PiQOperationContext(
        IPiQOperationIdentifier identifier,
        IPiQOperationState state,
        IPiQOperationMetrics metrics,
        IPiQCorrelationContext correlationContext,
        IPiQOperationValidator validator,
        IPiQOperationResources resources,
        ILogger logger,
    ...
    /// </summary>
    public IPiQOperationIdentifier Identifier { get; }

    /// <summary>
    /// Gets the operation state information
    /// </summary>
    public IPiQOperationState State { get; }

    /// <summary>
    /// Gets the operation metrics information
    /// </summary>
    public IPiQOperationMetrics Metrics { get; }
    ...
    public IDisposable CreateScope()
    {
        ...
        return new PiQOperationScope(defaultScopeName, this, _logger, Metrics);
    }
    ...
    {
        ObjectDisposedException.ThrowIf(_isDisposed, nameof(PiQOperationContext));
    }
}
