// CertApi.ArchitectureRules/ValidationFrameworkTests.cs
...
public class ValidationFrameworkTests : BaseArchitectureTest
{
    ...
    {
        var rule = Classes()
            .That().HaveFullName("CertApi.Abstractions.Validation.CertValidationContext")
    ...
    {
        var rule = Interfaces()
            .That().HaveFullNameContaining("CertApi.Abstractions.Validation.IValidationRule`1")
    ...
    public void ValidateAsync_Should_Accept_CancellationToken()
    {
        ...
        var rule = MethodMembers()
            .That().AreDeclaredIn(Interfaces().That().HaveFullNameContaining("CertApi.Abstractions.Validation.IValidationRule`1"))
    ...
    public void Validation_Types_Should_Not_Conflict_With_System_ComponentModel()
    {
        ...
        var rule2 = Types()
            ...
            .And().ResideInNamespace("CertApi.Abstractions.Validation")
            .Should().Exist()
