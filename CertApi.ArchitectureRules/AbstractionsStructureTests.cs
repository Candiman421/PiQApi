// CertApi.ArchitectureRules/AbstractionsStructureTests.cs
...
public class AbstractionsStructureTests : BaseArchitectureTest
{
    ...
    {
        var rule = Interfaces()
            .That().HaveFullNameContaining("CertApi.Abstractions.Results")
    ...
    {
        var rule = Interfaces()
            .That().HaveFullNameContaining("CertApi.Abstractions.Validation")
