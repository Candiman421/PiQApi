// CertApi.ArchitectureRules/ResultsPatternTests.cs
...
public class ResultsPatternTests : BaseArchitectureTest
{
    ...
    {
        var rule = Interfaces()
            .That().HaveFullName("CertApi.Abstractions.Results.ICertResult")
    ...
    {
        var rule = Interfaces()
            .That().HaveFullNameContaining("CertApi.Abstractions.Results.ICertResult`1")
            .Should().BeAssignableTo("CertApi.Abstractions.Results.ICertResult")
    ...
    {
        var rule = Interfaces()
            .That().HaveFullName("CertApi.Abstractions.Results.IResultError")
