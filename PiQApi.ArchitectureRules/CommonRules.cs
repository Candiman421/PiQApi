// PiQApi.ArchitectureRules/CommonRules.cs
...
public static class CommonRules
{
    ...
    public const string AbstractionsNamespace = "PiQApi.Abstractions";
    public const string CoreNamespace = "PiQApi.Exchange.Core";
    public const string ServiceNamespace = "PiQApi.Exchange.Service";
    public const string OperationsNamespace = "PiQApi.Exchange.Operations";
    public const string ClientNamespace = "PiQApi.Exchange.Client";
