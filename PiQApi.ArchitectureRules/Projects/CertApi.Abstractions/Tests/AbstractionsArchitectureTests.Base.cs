// PiQApi.ArchitectureRules/Projects/PiQApi.Abstractions/Tests/AbstractionsArchitectureTests.Base.cs
using System.Linq;
...
namespace PiQApi.ArchitectureRules.Projects.PiQApi.Abstractions.Tests
{
    public abstract class AbstractionsArchitectureTests
    {
        ...
        protected static IObjectProvider<IType> CoreLayer =>
            Types().That().ResideInNamespace("PiQApi.Abstractions.Core");

        protected static IObjectProvider<IType> ValidationLayer =>
            Types().That().ResideInNamespace("PiQApi.Abstractions.Validation");

        protected static IObjectProvider<IType> ResultsLayer =>
            Types().That().ResideInNamespace("PiQApi.Abstractions.Results");
