// PiQApi.Abstractions/Validation/Models/PiQValidationResultIsValid.cs
namespace PiQApi.Abstractions.Validation.Models;

/// <summary>
/// Implementation of a valid validation result with no errors
/// </summary>
public class PiQValidationResultIsValid : PiQValidationResult
{
    private static readonly IReadOnlyList<PiQValidationError> _emptyErrors = Array.Empty<PiQValidationError>();
    ...
    /// </summary>
    public override IReadOnlyList<PiQValidationError> Errors => _emptyErrors;
