// PiQApi.Abstractions/Validation/IPiQValidationResult.cs
...
/// </summary>
public interface IPiQValidationResult
{
    /// <summary>
    ...
    /// </summary>
    IReadOnlyList<PiQValidationError> Errors { get; }
    ...
    IEnumerable<PiQValidationError> GetErrorsBySeverity(ValidationSeverityType severity);
