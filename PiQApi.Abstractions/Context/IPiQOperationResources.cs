// PiQApi.Abstractions/Context/IPiQOperationResources.cs
...
namespace PiQApi.Abstractions.Context
{
    ...
    /// </summary>
    public interface IPiQOperationResources
    {
        /// <summary>
        ...
        Task<T> GetResourceAsync<T>(string resourceId, CancellationToken cancellationToken = default) where T : class, IPiQResource;
