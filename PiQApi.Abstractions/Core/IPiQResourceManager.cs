// PiQApi.Abstractions/Core/IPiQResourceManager.cs
namespace PiQApi.Abstractions.Core;

/// <summary>
/// Manages tracked resources and resource scopes
/// </summary>
public interface IPiQResourceManager : IAsyncDisposable
{
    /// <summary>
    ...
    Task<IPiQResourceScope> CreateScopeAsync(string? scopeId = null, CancellationToken cancellationToken = default);
