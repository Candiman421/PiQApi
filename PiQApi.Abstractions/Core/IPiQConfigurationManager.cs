// PiQApi.Abstractions/Core/IPiQConfigurationManager.cs
namespace PiQApi.Abstractions.Core;


//todo: A more comprehensive solution would be to create an IPiQException hierarchy in the Abstractions project, but that would require more extensive changes to the codebase.

/// <summary>
/// Manages configuration settings and initialization
/// </summary>
public interface IPiQConfigurationManager
{
    /// <summary>
