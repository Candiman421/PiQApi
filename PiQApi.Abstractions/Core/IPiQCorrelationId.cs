...
public interface IPiQCorrelationId
{
    ...
    IPiQCorrelationId WithProperty(string key, object value);
    ...
    IPiQCorrelationId WithProperties(IDictionary<string, object> properties);
