// PiQApi.Abstractions/Service/IPiQServiceBase.cs
...
/// </summary>
public interface IPiQServiceBase
{
    /// <summary>
    ...
    Task<object> GetServiceAsync(IPiQOperationContext context, CancellationToken cancellationToken = default);
    ...
    /// <param name="context">Operation context</param>
    /// <param name="cancellationToken">Cancellation token</param>
    Task EnsureAuthenticatedAsync(IPiQOperationContext context, CancellationToken cancellationToken = default);
