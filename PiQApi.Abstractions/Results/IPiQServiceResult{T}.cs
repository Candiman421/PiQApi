// PiQApi.Abstractions/Results/IPiQServiceResult{T}.cs
...
public interface IPiQServiceResult<out T> : IPiQServiceResult, IPiQResult<T>
{
    /// <summary>
    ...
    new IPiQServiceResult<T> WithProperty(string key, object value);
    ...
    new IPiQServiceResult<T> WithProperties(IDictionary<string, object> properties);
    ...
    new IPiQServiceResult<T> WithStatus(OperationStatusType status);
}
