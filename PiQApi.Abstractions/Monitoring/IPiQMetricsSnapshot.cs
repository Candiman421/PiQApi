...
public interface IPiQMetricsSnapshot
{
    ...
    IPiQMetricsSnapshot WithMetric(string name, object value);
    ...
    IPiQMetricsSnapshot WithMetrics(IDictionary<string, object> metrics);
